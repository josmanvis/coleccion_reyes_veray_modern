  ...
  return (
    <main className="min-h-screen pt-48 pb-32 px-6 md:px-12 lg:px-24 flex items-center justify-center bg-neutral-100">
      <motion.div 
        ...
        className="max-w-2xl w-full bg-white p-12 md:p-24 shadow-2xl border border-black/5 text-center"
      >
        <h1 className="font-serif text-5xl md:text-7xl font-light mb-8">Contact</h1>
        <p className="font-serif text-xl text-neutral-500 mb-16">
        ...
        <a 
          ...
          className="group relative inline-flex items-center justify-center py-6 px-12 border border-black hover:bg-black hover:text-white transition-colors duration-500 overflow-hidden"
        >
